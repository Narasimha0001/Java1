...
public class Buds {
	...
	public class NoiseBudsSelector {
		...
		public static void noiseBudsXtremeModel() {
			...
			while(true) {
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Noise Buds Xtreme variant:");
					System.out.println("1. Standard Edition  - $30");
					System.out.println("2. Special Edition (with customized case)  - $50");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Noise Buds Xtreme, Standard Edition  - $30");
                            price = 30;
							while(true) {
							...
							break;
						case "2":
							System.out.println("You've selected: Noise Buds Xtreme, Special Edition  - $50");
                            price = 50;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void noiseBudsAirModel() {
			System.out.println("Noise Buds Air Specifications:");
			...
			System.out.println("   - Price Range: $25 - $40");
			System.out.println("   - Features: ENC (Environmental Noise Cancellation), Lightweight");
            String choice;
			while(true) {
				System.out.print("Would you like to select the Noise Buds Air model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Noise Buds Air variant:");
					System.out.println("1. White  - $25");
					System.out.println("2. Black  - $35");
					System.out.println("3. Pink  - $40");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Noise Buds Air, White variant  - $25");
                            price = 25;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Noise Buds Air, Black variant  - $35");
                            price = 35;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Noise Buds Air, Pink variant  - $40");
                            price = 40;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void noiseBudsFitModel() {
			System.out.println("Noise Buds Fit Specifications:");
			...
			System.out.println("   - Price Range: $40 - $60");
			System.out.println("   - Features: Sweat & Water-resistant, Secure Fit");
            String choice;
			while(true) {
				System.out.print("Would you like to select the Noise Buds Fit model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Noise Buds Fit variant:");
					System.out.println("1. Standard Edition (Black)  - $40");
					System.out.println("2. Sport Edition (Neon Green)  - $60");
					System.out.println("3. Back");
					System.out.print("Enter your choice (1/2/3): ");
					String variant;
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Noise Buds Fit, Standard Edition  - $40");
                            price = 40;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Noise Buds Fit, Sport Edition  - $60");
                            price = 60;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void noiseBudsPlayModel() {
			System.out.println("Noise Buds Play Specifications:");
			System.out.println("1. Noise Buds Play");
			System.out.println("   - Battery Life: 14 hours (with charging case)");
			System.out.println("   - Bluetooth Version: 5.0");
			System.out.println("   - Price Range: $20 - $30");
			System.out.println("   - Features: Bass Boost, Noise Isolation");

            String choice;
			while(true) {
				System.out.print("Would you like to select the Noise Buds Play model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Noise Buds Play variant:");
					System.out.println("1. Black  - $20");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Noise Buds Play, Black variant  - $20");
                            price = 20;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Noise Buds Play, White variant  - $25");
                            price = 25;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Noise Buds Play, Blue variant  - $30");
                            price = 30;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void noiseBudsProModel() {
			...
			while(true) {
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Noise Buds Pro variant:");
					System.out.println("1. Black  - $50");
					System.out.println("2. White  - $65");
					System.out.println("3. Gold  - $80");
					System.out.println("4. Back");
					System.out.print("Enter your choice (1/2/3/4): ");
					String variant;
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Noise Buds Pro, Black variant  - $50");
                            price = 50;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Noise Buds Pro, White variant  - $65");
                            price = 65;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Noise Buds Pro, Gold variant  - $80");
                            price = 80;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
	...
	public class BoatBudsSelector {
		public  static void showSpecifications() {
			while(true) {
			System.out.println("!-----Available Models-----!");
			System.out.println("1. boAt Airdopes 450");
		...
		public static void boatAirdopes450Model() {
			System.out.println("boAt Airdopes 450 Specifications:");
			System.out.println("1. boAt Airdopes 450");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the boAt Airdopes 450 model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your boAt Airdopes 450 variant:");
					System.out.println("1. Black  - $25");
					System.out.println("2. White  - $30");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: boAt Airdopes 450, Black variant  - $25");
                            price = 25;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: boAt Airdopes 450, White variant  - $30");
                            price = 30;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: boAt Airdopes 450, Blue variant  - $40");
                            price = 40;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void boatAirdopes621Model() {
			System.out.println("boAt Airdopes 621 Specifications:");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the boAt Airdopes 621 model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your boAt Airdopes 621 variant:");
					System.out.println("1. Black  - $40");
					System.out.println("2. Green  - $50");
					System.out.println("3. Red  - $60");
					System.out.println("4. Back");
					System.out.print("Enter your choice (1/2/3/4): ");
					String variant;
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: boAt Airdopes 621, Black variant  - $40");
                            price = 40;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: boAt Airdopes 621, Green variant  - $50");
                            price = 50;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: boAt Airdopes 621, Red variant  - $60");
                            price = 60;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void boatAirdopes131Model() {
			System.out.println("boAt Airdopes 131 Specifications:");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the boAt Airdopes 131 model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your boAt Airdopes 131 variant:");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: boAt Airdopes 131, Black variant  - $15");
                            price = 15;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: boAt Airdopes 131, Blue variant  - $20");
                            price = 20;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: boAt Airdopes 131, Red variant  - $25");
                            price = 25;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void boatAirdopes171Model() {
			System.out.println("boAt Airdopes 171 Specifications:");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the boAt Airdopes 171 model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your boAt Airdopes 171 variant:");
					System.out.println("1. Black  - $25");
					System.out.println("2. White  - $30");
					System.out.println("3. Blue  - $40");
					System.out.println("4. Back");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: boAt Airdopes 171, Black variant  - $25");
                            price = 25;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: boAt Airdopes 171, White variant  - $30");
                            price = 30;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: boAt Airdopes 171, Blue variant  - $40");
                            price = 40;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void boatAirdopes641Model() {
			System.out.println("boAt Airdopes 641 Specifications:");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the boAt Airdopes 641 model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your boAt Airdopes 641 variant:");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: boAt Airdopes 641, Black variant  - $45");
                            price = 45;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: boAt Airdopes 641, White variant  - $55");
                            price = 55;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: boAt Airdopes 641, Grey variant  - $65");
                            price = 65;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
	...
	public class RealmeBudsSelector {
		...
		public static void realmeBudsAirModel() {
			System.out.println("Realme Buds Air Specifications:");
			System.out.println("1. Realme Buds Air");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the Realme Buds Air model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Realme Buds Air variant:");
					System.out.println("1. White  - $50");
					System.out.println("2. Black  - $50");
					System.out.println("3. Yellow  - $50");
					System.out.println("4. Back");
					System.out.print("Enter your choice (1/2/3/4): ");
					String variant;
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Realme Buds Air, White variant  - $30");
                            price = 30;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Realme Buds Air, Black variant  - $40");
                            price = 40;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Realme Buds Air, Yellow variant  - $50");
                            price = 50;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void realmeBudsQ2Model() {
			System.out.println("Realme Buds Q2 Specifications:");
			...
			System.out.println("   - Features: ANC (Active Noise Cancellation), 10mm Drivers");
            	String choice;
			while(true) {
				System.out.print("Would you like to select the Realme Buds Q2 model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Realme Buds Q2 variant:");
					System.out.println("1. Black  - $40");
					System.out.println("2. White  - $50");
					System.out.println("3. Green  - $60");
					System.out.println("4. Back");
					System.out.print("Enter your choice (1/2/3/4): ");
					String variant;
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Realme Buds Q2, Black variant  - $40");
                            price = 40;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Realme Buds Q2, White variant  - $50");
                            price = 50;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Realme Buds Q2, Green variant  - $60");
                            price = 60;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void realmeBudsNeoModel() {
			System.out.println("Realme Buds Neo Specifications:");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the Realme Buds Neo model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Realme Buds Neo variant:");
					System.out.println("1. Blue  - $20");
					System.out.println("2. Black  - $25");
					System.out.println("3. Red  - $30");
					System.out.println("4. Back");
					System.out.print("Enter your choice (1/2/3/4): ");
					String variant;
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Realme Buds Neo, Blue variant  - $20");
                            price = 20;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Realme Buds Neo, Black variant  - $25");
                            price = 25;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Realme Buds Neo, Red variant  - $30");
                            price = 30;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void realmeBuds2ProModel() {
			System.out.println("Realme Buds 2 Pro Specifications:");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the Realme Buds 2 Pro model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Realme Buds 2 Pro variant:");
					System.out.println("1. Black  - $40");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Realme Buds 2 Pro, Black variant  - $40");
                            price = 40;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Realme Buds 2 Pro, Blue variant  - $45");
                            price = 45;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Realme Buds 2 Pro, Green variant  - $55");
                            price = 55;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void realmeBudsFlowModel() {
			System.out.println("Realme Buds Flow Specifications:");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the Realme Buds Flow model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Realme Buds Flow variant:");
					System.out.println("1. Black  - $25");
					System.out.println("2. White  - $30");
					System.out.println("3. Green  - $40");
					System.out.println("4. Back");
					System.out.print("Enter your choice (1/2/3/4): ");
					String variant;
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Realme Buds Flow, Black variant  - $25");
                            price = 25;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Realme Buds Flow, White variant  - $30");
                            price = 30;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Realme Buds Flow, Green variant  - $40");
                            price = 40;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
	...
	public class BoultBudsSelector {
		public  static void showSpecifications() {
			...
			System.out.println("4. Boult Airdopes 200");
		...
		public static void boultAirBassZModel() {
			System.out.println("Boult AirBass Z Specifications:");
			System.out.println("1. Boult AirBass Z");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the Boult AirBass Z model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Boult AirBass Z variant:");
					System.out.println("1. Black  - $20");
					System.out.println("2. White  - $25");
					System.out.println("3. Blue  - $30");
					System.out.println("4. Back");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Boult AirBass Z, Black variant  - $20");
                            price = 20;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Boult AirBass Z, White variant  - $25");
                            price = 25;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Boult AirBass Z, Blue variant  - $30");
                            price = 30;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void boultAirdopes441Model() {
			System.out.println("Boult Airdopes 441 Specifications:");
			System.out.println("1. Boult Airdopes 441");
			System.out.println("   - Battery Life: 24 hours (with charging case)");
			System.out.println("   - Bluetooth Version: 5.0");
			System.out.println("   - Price Range: $30 - $40");
			System.out.println("   - Features: IPX7 Water Resistance, 6mm Drivers, Touch Controls");
            String choice;
			while(true) {
				System.out.print("Would you like to select the Boult Airdopes 441 model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Boult Airdopes 441 variant:");
					System.out.println("1. Black  - $30");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Boult Airdopes 441, Black variant  - $30");
                            price = 30;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Boult Airdopes 441, White variant  - $35");
                            price = 35;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Boult Airdopes 441, Green variant  - $40");
                            price = 40;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void boultAirdopesX1Model() {
			System.out.println("Boult Airdopes X1 Specifications:");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the Boult Airdopes X1 model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Boult Airdopes X1 variant:");
					System.out.println("1. Black  - $25");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Boult Airdopes X1, Black variant  - $25");
                            price = 25;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Boult Airdopes X1, Blue variant  - $30");
                            price = 30;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Boult Airdopes X1, Red variant  - $35");
                            price = 35;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void boultAirdopes200Model() {
			System.out.println("Boult Airdopes 200 Specifications:");
			System.out.println("1. Boult Airdopes 200");
			System.out.println("   - Battery Life: 20 hours (with charging case)");
			System.out.println("   - Bluetooth Version: 5.0");
			System.out.println("   - Price Range: $25 - $35");
			System.out.println("   - Features: 6mm Drivers, In-Ear Design, Fast Charging");
            	String choice;
			while(true) {
				System.out.print("Would you like to select the Boult Airdopes 200 model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Boult Airdopes 200 variant:");
					System.out.println("1. Black  - $25");
					System.out.println("2. White  - $30");
					System.out.println("3. Red  - $35");
					System.out.println("4. Back");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Boult Airdopes 200, Black variant  - $25");
                            price = 25;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Boult Airdopes 200, White variant  - $30");
                            price = 30;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Boult Airdopes 200, Red variant  - $35");
                            price = 35;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
		...
		public static void boultAirdopesInfinityModel() {
			...
			while(true) {
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Boult Airdopes Infinity variant:");
					System.out.println("1. Black  - $40");
					...
					while(true) {
						...
						switch(variant) {
						case "1":
							System.out.println("You've selected: Boult Airdopes Infinity, Black variant  - $40");
                            price = 40;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Boult Airdopes Infinity, White variant  - $45");
                            price = 45;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Boult Airdopes Infinity, Blue variant  - $50");
                            price = 50;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
	...
	public class AppleBudsSelector {
		...
		public static void appleAirPods2Model() {
			System.out.println("Apple AirPods 2nd Generation Specifications:");
		...
		// 	System.out.print("Would you like to select the Apple AirPods 2 model? (yes/no): ");
		// 	while(true) {
		// 		String choice = scanner.next();

		// 		if (choice.equalsIgnoreCase("yes")) {
		// 			System.out.println("Select your Apple AirPods 2 variant:");
		...
		// 				switch(variant) {
		// 				case "1":
		// 					System.out.println("You've selected: Apple AirPods 2, White variant");
		// 					break;
		// 				default:
		...
		public static void appleAirPodsProModel() {
			System.out.println("Apple AirPods Pro Specifications:");
		...
		// 	System.out.print("Would you like to select the Apple AirPods Pro model? (yes/no): ");
		// 	while(true) {
		// 		String choice = scanner.next();

		// 		if (choice.equalsIgnoreCase("yes")) {
		// 			System.out.println("Select your Apple AirPods Pro variant:");
		// 			System.out.println("1. White");
		// 			System.out.print("Enter your choice (1): ");
		// 			String variant = scanner.next();
		...
		// 			switch(variant) {
		// 			case "1":
		// 				System.out.println("You've selected: Apple AirPods Pro, White variant");
		// 				break;
		// 			default:
		// 				System.out.println("Invalid selection");
		// 			}
		...
		public static void appleAirPods3Model() {
			System.out.println("Apple AirPods 3rd Generation Specifications:");
		...
		// 	System.out.print("Would you like to select the Apple AirPods 3 model? (yes/no): ");
		// 	while(true) {
		// 		String choice = scanner.next();

		// 		if (choice.equalsIgnoreCase("yes")) {
		// 			System.out.println("Select your Apple AirPods 3 variant:");
		// 			System.out.println("1. White");
		// 			System.out.print("Enter your choice (1): ");
		// 			String variant = scanner.next();
		...
		// 			switch(variant) {
		// 			case "1":
		// 				System.out.println("You've selected: Apple AirPods 3, White variant");
		// 				break;
		// 			default:
		// 				System.out.println("Invalid selection");
		// 			}
		...
		public static void appleAirPodsPro2Model() {
			System.out.println("Apple AirPods Pro 2nd Generation Specifications:");
			...
			// System.out.print("Would you like to select the Apple AirPods Pro 2 model? (yes/no): ");
			// while(true) {
			// 	String choice = scanner.next();

			// 	if (choice.equalsIgnoreCase("yes")) {
			// 		System.out.println("Select your Apple AirPods Pro 2 variant:");
			...
			// 		switch(variant) {
			// 		case "1":
			// 			System.out.println("You've selected: Apple AirPods Pro 2, White variant");
			// 			break;
			// 		default:
			// 			System.out.println("Invalid selection");
			// 		}
		...
		public static void appleAirPodsMaxModel() {
			System.out.println("Apple AirPods Max Specifications:");
            ...
            String choice;
			while(true) {
				System.out.print("Would you like to select the Apple AirPods Max model? (yes/no): ");
				choice = scanner.next();
				if(choice.equalsIgnoreCase("yes")|| choice.equalsIgnoreCase("no")) break;
				else System.out.println(" Invalid Selection. ");
			}
				...
				if (choice.equalsIgnoreCase("yes")) {
                    while(true){
					System.out.println("Select your Apple AirPods Max variant:");
					...
					while(true) {
						...
						else System.out.println(" Invalid Selection. Please Enter your choice (1/2/3/4/5): ");
					}

						switch(variant) {
						case "1":
							System.out.println("You've selected: Apple AirPods Max, Silver variant  -$549");
                            price = 549;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "2":
							System.out.println("You've selected: Apple AirPods Max, Space Gray variant  -$549");
                            price = 549;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "3":
							System.out.println("You've selected: Apple AirPods Max, Sky Blue variant  -$549");
                            price = 549;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
							...
							break;
						case "4":
							System.out.println("You've selected: Apple AirPods Max, Pink variant  -$549");
                            price = 549;
							while(true) {
								System.out.println("!---Do you want to add this to cart---!(yes/no)");
								sc = scanner.next();
	...
	public static void main(String[] args) {
		...
		System.out.println("Choose from our Buds models:");
